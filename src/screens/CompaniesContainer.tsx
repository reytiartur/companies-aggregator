...
const CompaniesContainer = () => {
  ...
  return (
    <div className="p-4 h-full grid grid-cols-1 gap-6 pt-3 pb-40 sm:grid sm:grid-cols-2 sm:gap-6 sm:auto-rows-max md:gap-6 md:p-6 md:pt-3 md:pb-40 lg:grid-cols-3 xl:grid-cols-4 xl:gap-4 2xl:gap-6 bg-background overflow-y-auto">
        {loading ? (
